...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
  <br />
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="ddlVitri" runat="server" Height="25px" Width="155px" DataSourceID="SqlDataSource1" DataTextField="ViTri" DataValueField="ViTri">
            </asp:DropDownList>
    ...
    <tr>
        <td colspan="4" class="auto-style5">
            <asp:GridView ID="GridView1" runat="server" Height="292px" Width="100%" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" OnRowDeleting="GridView1_RowDeleting">
